...
import static ru.javaops.masterjava.persist.CityTestData.S_PETERSBURG;
...
public class CityDaoTest extends AbstractDaoTest<CityDao> {
    ...
    public void getByCode() {
        City city = dao.getByCode(S_PETERSBURG.getCode());
        Assert.assertEquals(S_PETERSBURG, city);
    }
